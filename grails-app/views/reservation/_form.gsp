<%@ page import="bibliotheque.Reservation" %>
...
<div class="fieldcontain ${hasErrors(bean: reservationInstance, field: 'livres', 'error')} ">
	...
	<g:select name="livres" from="${bibliotheque.Livre.list()}" multiple="multiple" optionKey="id" size="5" value="${reservationInstance?.livres*.id}" class="many-to-many"/>
</div>
